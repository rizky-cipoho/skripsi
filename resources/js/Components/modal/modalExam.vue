                    ...
                    >
                        ...
                        >
                            ...
                            <div class="mt-3">
                                ...
                                />
                                <select v-model="lesson" class="border border-gray-200">
                                    <option v-for="less in props.lessons" :value="less.id">{{less.lesson}}</option>
                                </select>
...
const examName = ref("")
const lesson = ref(1)
const emit = defineEmits(["closeModal", "add"]);
const deActive = (val) => {
    emit("closeModal");
};
const add = () => {
    emit("add", examName.value, lesson.value);
};
</script>
